...
import {allOrdersIcon, notificationIcon} from '../../../utils/imagePath'
      ...
      items.push(
        <TouchableOpacity
          ...
          <View
            ...
            <Image style={{height: 70, width: 70}} source={allOrdersIcon} />
          </View>
          <View
            style={{
              flex: 1,
          ...
          <View
            ...
            {index == 0 || index == 1 ? (
              <TouchableOpacity
                ...
                <Text style={{color: 'white', fontFamily:Fonts.PoppinsRegular}}>Received</Text>
              </TouchableOpacity>
            ) : null}
          </View>
        </TouchableOpacity>,
