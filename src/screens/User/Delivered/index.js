    ...
    for (let i = 0; i < 3; i++) {
      orders.push(
        <View style={styles.orderContainer}>
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate('User_ReturnOrderConfirmation')}
            style={[{
              height: 30,
              width: 100,
            ...
            <Text style={{color: 'white',fontFamily:Fonts.PoppinsRegular, fontSize:12}}>Return</Text>
          </TouchableOpacity>
        </View>,
      );
    }
    return (
      <View style={styles.container}>
        ...
        <View style={styles.headingContainer}>
          <Text style={styles.headingText}>Delivered</Text>
        </View>
